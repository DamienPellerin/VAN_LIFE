...
try {
    ...
    if ($reservation->id_users != $_SESSION['user']->id_users) {
        header('Location: /controllers/homeControllers.php');
        exit;
    }
       ...
       if (empty($id_vehicles)) {
        ...
        if (empty($errors)) {
            ...
            if ($isModifyLocation) {
                ...
                header('location: /controllers/user/modify/modifyLocationUserCtrl.php');
                exit;
            }
        }
    }
...
include(__DIR__ . '/../../../views/modifyLocationUser.php');
